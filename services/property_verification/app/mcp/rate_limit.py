"""Sliding-window rate limiter for the pv-mcp tools.

Keyed by caller subject (the local OS user for stdio transport) so one
abusive agent session cannot exhaust the upstream service quota for others.
"""
